...
<div class="container bg">
  <div class="row-fluid">
    <div class="span12">
      <div>
<center><h5>Laporan Barang Masuk Dari Tanggal <?php echo"$dari Sampai Tanggal $sampai";?></h5></center>
  ...
  <table border="1" width="100%">
   ...
   $tampil = mysqli_query($konek,"SELECT barang.id_barang,barang.nama_barang,detail_masuk.harga_beli,variasi_ukuran.nama_variasi_ukuran,detail_masuk.jumlah,detail_masuk.id_detail_masuk, merek.nama_merek, supplier.nama_supplier 
															 FROM detail_masuk JOIN detail_barang ON detail_masuk.id_detail_barang=detail_barang.id_detail_barang
															 ...
															 JOIN barang_masuk ON detail_masuk.id_barang_masuk=barang_masuk.id_barang_masuk
															 JOIN supplier ON supplier.id_supplier=barang_masuk.id_supplier
															 WHERE (barang_masuk.tanggal_masuk BETWEEN '$mulai' AND '$selesai')");
